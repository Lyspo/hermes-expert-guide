...
const lessons = defineCollection({
  ...
  schema: z.object({
    ...
    /**
     * How this lesson is mastered. Both forms are optional and mutually exclusive; a
     * lesson with neither can still be marked read, it simply does not advance the
     * version ladder.
     *
